...
public class LinkifyMovement extends LinkMovementMethod {
   ...
   * @param textViews   The TextViews on which a {@link LinkifyMovement} should be registered.
   * @return The registered {@link LinkifyMovement} on the TextViews.
   */
  ...
  /**
   * Recursively register a {@link LinkifyMovement} on every TextView inside a layout.
   *
   * @param linkifyMask One of {@link Linkify#ALL}, {@link Linkify#PHONE_NUMBERS}, {@link Linkify#MAP_ADDRESSES},
   *                    {@link Linkify#WEB_URLS} and {@link Linkify#EMAIL_ADDRESSES}.
   * @return The registered {@link LinkifyMovement} on the TextViews.
   ...
   * @return The registered {@link LinkifyMovement} on the TextViews.
   */
  public static LinkifyMovement linkify(int linkifyMask, Activity activity) {
   ...
   * @return The registered {@link LinkifyMovement} on the TextViews.
   */
  public static LinkifyMovement linkifyHtml(Activity activity) {
